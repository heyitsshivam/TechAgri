...
public class PageConfig implements WebMvcConfigurer {
    ...
    public void addViewControllers(ViewControllerRegistry registry) {
        ...
        registry.addViewController("/viewseedinfo").setViewName("addseedinfo");
        registry.addViewController("/wholesalelogin").setViewName("wholesalelogin");
        registry.addViewController("/signup").setViewName("signup");

        registry.addViewController("/viewseedinfo").setViewName("viewseedinfo");
        registry.addViewController("/addseedinfo").setViewName("viewseedinfo");
